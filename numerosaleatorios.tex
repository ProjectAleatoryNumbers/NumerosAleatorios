...
Donde tenemos la semilla $X\textsubscript{0}\geq 0$ , un multiplicador $a \geq 0$, incremento $c>0$ y un m\'odulo $m >X\textsubscript{0}$ ,$a$ y $c$ .

Existen m\'etodos en la bibliograf\'ia adjunta para escoger estos valores para que sean los m\'as adecuados posibles tomando en cuenta los bits del procesador, y los factores primos del multiplicador, del incremento y del m\'odulo tal que se evite la degeneraci\'on de la secuencia de estos n\'umeros pseudoaleatorios y adem\'as la longitud de esta secuencia sea la mayor posible.

Entonces como puede deducirse de todo lo anterior dicho, nuestro dise\~no del experimento consiste en realizar la implementaci\'on de estos m\'etodos en los cuales se puede destacar tres etapas bien diferenciadas:
