...
e^{-\dfrac{(t-\mu)^2}{2\sigma^2}} , z \in {\rm I\!R} $$
...
$$p(z) = \dfrac {1}{\sqrt{2\pi}}
e^{-\dfrac{x^2}{2}} dt, x \in {\rm I\!R} $$
Debemos notar que haciendo un cambio de variable en la funci\'on de distribuci\'on normal $$z=\dfrac{x-\mu}{\sigma}$$ podemos reducir y obtener la distribuci\'on normal est\'andar:

$$\Phi_{\mu,\sigma^2}(z) = \dfrac {1}{\sqrt{2\pi}}
\int_{-\infty}^{z} e^{-\dfrac{x^2}{2}} dt, x \in {\rm I\!R} $$
